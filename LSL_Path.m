function [distance] = LSL_Path(q1,q2)
%LSL_PATH Summary of this function goes here
%   q1 - stan poczatkowy
%   q2 - stan startowy
...
T1=[C1(:,1)+C1C2(:,2)*R*inv_distC1C2,  C1(:,2)-C1C2(:,1)*R*inv_distC1C2];  %X_T1, Y_T1
T2=[C2(:,1)+C1C2(:,2)*R*inv_distC1C2,  C2(:,2)-C1C2(:,1)*R*inv_distC1C2];  %X_T2, Y_T2
